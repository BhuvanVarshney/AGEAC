...
public class BeginnersLeaderboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beginners_leaderboard);
        ...
        dbAdapter.addLogEntry("BeginnersLeaderboard", "OnCreate");
        ...
        viewLeaderOverall = findViewById(R.id.view_beginners_leader_overall);
        viewLeaderCompletion = findViewById(R.id.view_beginners_leader_completion);
        viewLeaderAccuracy = findViewById(R.id.view_beginners_leader_accuracy);
        viewLeaderXP = findViewById(R.id.view_beginners_leader_xp);
        viewLeaderDaysStreak = findViewById(R.id.view_beginners_leader_days_streak);
        viewLeaderAssignmentsCompleted = findViewById(R.id.view_beginners_leader_assignments_completed);

        txtvUserPositionOverall = findViewById(R.id.txtv_beginners_leaderboard_user_overall_position);
        txtvLeaderNameOverall = findViewById(R.id.txtv_beginners_leaderboard_overall_leader_name);
        txtvOverallLeaderCompletionValue = findViewById(R.id.txtv_beginners_leaderboard_overall_leader_completion);
        txtvOverallLeaderAccuracyValue = findViewById(R.id.txtv_beginners_leaderboard_overall_leader_accuracy);
        txtvOverallLeaderXPValue = findViewById(R.id.txtv_beginners_leaderboard_overall_leader_xp);
        txtvOverallLeaderDaysStreak = findViewById(R.id.txtv_beginners_leaderboard_overall_leader_days_streak);
        txtvOverallLeaderAssignmentsCompleted = findViewById(R.id.txtv_beginners_leaderboard_overall_leader_assignments_completed);

        txtvUserPositionCompletion = findViewById(R.id.txtv_beginners_leaderboard_user_completion_position);
        txtvUserPointsCompletion = findViewById(R.id.txtv_beginners_leaderboard_user_completion_points);
        txtvLeaderNameCompletion = findViewById(R.id.txtv_beginners_leaderboard_completion_leader_name);
        txtvLeaderPointsCompletion = findViewById(R.id.txtv_beginners_leaderboard_completion_leader_points);

        txtvUserPositionAccuracy = findViewById(R.id.txtv_beginners_leaderboard_user_accuracy_position);
        txtvUserPointsAccuracy = findViewById(R.id.txtv_beginners_leaderboard_user_accuracy_points);
        txtvLeaderNameAccuracy = findViewById(R.id.txtv_beginners_leaderboard_accuracy_leader_name);
        txtvLeaderPointsAccuracy = findViewById(R.id.txtv_beginners_leaderboard_accuracy_leader_points);

        txtvUserPositionXP = findViewById(R.id.txtv_beginners_leaderboard_user_xp_position);
        txtvUserPointsXP = findViewById(R.id.txtv_beginners_leaderboard_user_xp_points);
        txtvLeaderNameXP = findViewById(R.id.txtv_beginners_leaderboard_xp_leader_name);
        txtvLeaderPointsXP = findViewById(R.id.txtv_beginners_leaderboard_xp_leader_points);

        txtvUserPositionDaysStreak = findViewById(R.id.txtv_beginners_leaderboard_user_days_streak_position);
        txtvUserPointsDaysStreak = findViewById(R.id.txtv_beginners_leaderboard_user_days_streak_points);
        txtvLeaderNameDaysStreak = findViewById(R.id.txtv_beginners_leaderboard_days_streak_leader_name);
        txtvLeaderPointsDaysStreak = findViewById(R.id.txtv_beginners_leaderboard_days_streak_leader_points);

        txtvUserPositionAssignmentsCompleted = findViewById(R.id.txtv_beginners_leaderboard_user_assignments_completed_position);
        txtvUserPointsAssignmentsCompleted = findViewById(R.id.txtv_beginners_leaderboard_user_assignments_completed_points);
        txtvLeaderNameAssignmentsCompleted = findViewById(R.id.txtv_beginners_leaderboard_assignments_completed_leader_name);
        txtvLeaderPointsAssignmentsCompleted = findViewById(R.id.txtv_beginners_leaderboard_assignments_completed_leader_points);

        txtvTotalUsers = findViewById(R.id.txtv_total_beginners);

        progressBar = findViewById(R.id.beginners_leaderboard_progressbar);
        progressBar.setVisibility(View.INVISIBLE);

        backBtn = findViewById(R.id.beginners_leaderboard_back_btn);
        ...
        ConnectionChecker connectionChecker = new ConnectionChecker(BeginnersLeaderboardActivity.this);
        boolean isConnectionAvailable = connectionChecker.isInternetConnected();
        if (isConnectionAvailable)
            prepareLeaderBoard();
        else {
            AlertDialog.Builder builder = new AlertDialog.Builder(BeginnersLeaderboardActivity.this);
        ...
        docRef.update(updates).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(BeginnersLeaderboardActivity.this, "Something went wrong. Try again later.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    for (DocumentSnapshot document : task.getResult()) {
                        if (document.getString(BackUpDBKeys.BACKUPDB_KEY_USER_TYPE).equalsIgnoreCase("Beginner")) {
